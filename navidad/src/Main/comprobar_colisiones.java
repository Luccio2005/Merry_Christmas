    ...
    public void comprobarsuelo(entidad entidad){
        ...
        switch (entidad.direccion){
            case "up":
                ...
                suelonum1= gp.sueloM.mapNum[entidadizqcolumna][entidadarrfila];
                suelonum2= gp.sueloM.mapNum[entidaddercolumna][entidadarrfila];
            ...
            case "down":
                ...
                suelonum1= gp.sueloM.mapNum[entidadizqcolumna][entidadabafila];
                suelonum2= gp.sueloM.mapNum[entidaddercolumna][entidadabafila];
                if(gp.sueloM.suelo[suelonum1].colision == true || gp.sueloM.suelo[suelonum2].colision == true){
                    entidad.colisioon = true;
                } break;
            case "left":
                ...
                suelonum1= gp.sueloM.mapNum[entidadizqcolumna][entidadarrfila];
                suelonum2= gp.sueloM.mapNum[entidadizqcolumna][entidadabafila];
                if(gp.sueloM.suelo[suelonum1].colision == true || gp.sueloM.suelo[suelonum2].colision == true){
                    entidad.colisioon = true;
                } break;
            case "right":
                entidaddercolumna = (entidaddermundox + entidad.velocidad)/gp.tileSize;
                suelonum1= gp.sueloM.mapNum[entidaddercolumna][entidadarrfila];
                suelonum2= gp.sueloM.mapNum[entidaddercolumna][entidadabafila];
                if(gp.sueloM.suelo[suelonum1].colision == true || gp.sueloM.suelo[suelonum2].colision == true){
                    entidad.colisioon = true;
                } break;
